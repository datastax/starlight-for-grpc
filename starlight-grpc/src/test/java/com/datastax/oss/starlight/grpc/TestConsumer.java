...
public class TestConsumer {
  ...
  public static void main(String[] args) throws Exception {
    ...
    StreamObserver<ConsumerResponse> messageStreamObserver = new StreamObserver<ConsumerResponse>() {
      @Override
    ...
    while(true) {
      ...
      if (msgId != null) {
                ackStreamObserver.onNext(ConsumerRequest.newBuilder().setAck(ConsumerAck.newBuilder()
